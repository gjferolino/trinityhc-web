  ...
  <Container className="home-custom-container-image text-center">
    ...
    <div className="content-container">
      ...
      <p className="description">
        Our clinics are strategically located around Singapore and we have been
        providing medical services to the community and our corporate clients
        for more than 40 years. Our strengths are in Corporate Health Services,
        Occupational Health Services, Offshore and Maritime Health Services
        (e.g. Fitness for OGUK, BOSIET, Seafarer medical examination, UK's MCA
        ENG 1 Equivalent) and Drug & Alcohol Screening.
      </p>
      <div className="spacer"></div>
      <p className="description">
